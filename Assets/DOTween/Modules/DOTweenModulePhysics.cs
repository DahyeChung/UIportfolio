...
namespace DG.Tweening
{
	public static class DOTweenModulePhysics
    {
        ...
        /// Also stores the rigidbody as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="endValue">The end value to reach</param><param _name="duration">The duration of the tween</param>
        /// <param _name="mode">Rotation mode</param>
        ...
        /// Also stores the rigidbody as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="towards">The position to look at</param><param _name="duration">The duration of the tween</param>
        /// <param _name="axisConstraint">Eventual axis constraint for the rotation</param>
        /// <param _name="up">The vector that defines in which direction up is (default: Vector3.up)</param>
        ...
        /// <param _name="path">The waypoints to go through</param>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="pathType">The type of path: Linear (straight path) or CatmullRom (curved CatmullRom path)</param>
        /// <param _name="pathMode">The path mode: 3D, side-scroller 2D, top-down 2D</param>
        /// <param _name="resolution">The resolution of the path (useless in case of Linear paths): higher resolutions make for more detailed curved paths but are more expensive.
        /// Defaults to 10, but a value of 5 is usually enough if you don't have dramatic long curves between waypoints</param>
        /// <param _name="gizmoColor">The color of the path (shown when gizmos are active in the Play panel and the tween is running)</param>
        ...
        /// <param _name="path">The waypoint to go through</param>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="pathType">The type of path: Linear (straight path) or CatmullRom (curved CatmullRom path)</param>
        /// <param _name="pathMode">The path mode: 3D, side-scroller 2D, top-down 2D</param>
        /// <param _name="resolution">The resolution of the path: higher resolutions make for more detailed curved paths but are more expensive.
        /// Defaults to 10, but a value of 5 is usually enough if you don't have dramatic long curves between waypoints</param>
        /// <param _name="gizmoColor">The color of the path (shown when gizmos are active in the Play panel and the tween is running)</param>
