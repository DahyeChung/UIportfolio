...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// Also stores the image as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="endValue">The end value to reach (0 to 1)</param><param _name="duration">The duration of the tween</param>
        ...
        /// <param _name="endValue">The end value to reach</param><param _name="duration">The duration of the tween</param>
        /// <param _name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="punch">The direction and strength of the punch (added to the RectTransform's current position)</param>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="vibrato">Indicates how much will the punch vibrate</param>
        /// <param _name="elasticity">Represents how much (0 to 1) the vector will go beyond the starting position when bouncing backwards.
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="strength">The shake strength</param>
        /// <param _name="vibrato">Indicates how much will the shake vibrate</param>
        /// <param _name="randomness">Indicates how much the shake will be random (0 to 180 - values higher than 90 kind of suck, so beware). 
        /// Setting it to 0 will shake along a single direction.</param>
        /// <param _name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        /// <param _name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</param>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="strength">The shake strength on each axis</param>
        /// <param _name="vibrato">Indicates how much will the shake vibrate</param>
        /// <param _name="randomness">Indicates how much the shake will be random (0 to 180 - values higher than 90 kind of suck, so beware). 
        /// Setting it to 0 will shake along a single direction.</param>
        /// <param _name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        ...
        /// Also stores the RectTransform as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="endValue">The end value to reach</param>
        /// <param _name="jumpPower">Power of the jump (the max height of the jump is represented by this plus the final Y offset)</param>
        /// <param _name="numJumps">Total number of jumps</param>
        /// <param _name="duration">The duration of the tween</param>
        /// <param _name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        ...
        /// Also stores the Text as the tween's target so it can be used for filtered operations</summary>
        /// <param _name="endValue">The end string to tween to</param><param _name="duration">The duration of the tween</param>
        /// <param _name="richTextEnabled">If TRUE (default), rich text will be interpreted correctly while animated,
        /// otherwise all tags will be considered as normal text</param>
        /// <param _name="scrambleMode">The type of scramble mode to use, if any</param>
        /// <param _name="scrambleChars">A string containing the characters to use for scrambling.
